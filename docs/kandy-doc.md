...
-   `camera` **[Array][14]&lt;[call.DeviceInfo][25]>** A list of camera device information.
-   `microphone` **[Array][14]&lt;[call.DeviceInfo][25]>** A list of microphone device information.
-   `speaker` **[Array][14]&lt;[call.DeviceInfo][25]>** A list of speaker device information.
...
Can be retrieved using the [call.getAll][33] or [call.getById][32] APIs.
...
-   `from` **[user.UserID][36]** A unique identifier (uri) of the person who made the call.
-   `to` **[user.UserID][36]** A unique identifier (uri) of the person who receives the call.
-   `direction` **[string][8]** The direction in which the call was created. Can be 'outgoing' or 'incoming'.
-   `state` **[string][8]** The current state of the call. See [call.states][37] for possible states.
...
-   `customParameters` **[Array][14]&lt;[call.CustomParameter][39]>** The custom parameters set for the call.
...
The [call.getById][32] API can be used to retrieve
...
The SDK will emit a [call:stateChange][50]
   ...
   [call.getById][32] API can be used to retrieve the latest call state
...
-   `userId` **[user.UserID][36]** The User ID of the user.
...
-   `filters` **[Object][7]** The filter options for the search.
    -   `filters.userId` **[user.UserID][36]?** Matches the User ID of the user.
