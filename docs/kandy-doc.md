...
-   `customParameters` **[Array][12]&lt;[call.CustomParameter][26]>** The custom parameters set for the call.
...
-   `options` **[Object][6]?** 
    ...
    -   `options.customParameters` **[Array][12]&lt;[call.CustomParameter][26]>?** Custom SIP header parameters for the SIP backend.
...
-   `customParameters` **[Array][12]&lt;[call.CustomParameter][26]>** The custom parameters to set.
