...
The same behaviour as the `changeInputDevices` API can be implemented
   using the general-purpose [call.replaceTrack][30] API. This API can
...
See the [user.fetch][54] and [user.search][55] APIs for details about
