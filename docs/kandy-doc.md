...
-   `camera` **[Array][14]&lt;[call.DeviceInfo][24]>** A list of camera device information.
-   `microphone` **[Array][14]&lt;[call.DeviceInfo][24]>** A list of microphone device information.
-   `speaker` **[Array][14]&lt;[call.DeviceInfo][24]>** A list of speaker device information.
...
Can be retrieved using the [call.getAll][32] or [call.getById][31] APIs.
...
-   `bandwidth` **[call.BandwidthControls][36]** The bandwidth limitations set for the call.
-   `customParameters` **[Array][14]&lt;[call.CustomParameter][37]>** The custom parameters set for the call.
...
The [call.getById][31] API can be used to retrieve
...
-   `options` **[Object][7]?** 
    -   `options.bandwidth` **[call.BandwidthControls][36]?** Options for configuring media's bandwidth.
    ...
    -   `options.customParameters` **[Array][14]&lt;[call.CustomParameter][37]>?** Custom SIP header parameters for the SIP backend.
...
The SDK will emit a [call:stateChange][50]
   ...
   [call.getById][31] API can be used to retrieve the latest call state
...
-   `customParameters` **[Array][14]&lt;[call.CustomParameter][37]>** The custom parameters to set.
...
-   `type` **[string][8]** The type of message that was sent. See [conversation.chatTypes][72] for valid types.
...
[36]: #callbandwidthcontrols

[37]: #callcustomparameter
...
[68]: conversation.Message.addPart
