...
-   `options` **[Object][6]?** 
    ...
    -   `options.customParameters` **[Array][12]&lt;[call.CustomParameter][28]>?** Custom SIP header parameters for the SIP backend.
...
-   `customParameters` **[Array][12]&lt;[call.CustomParameter][28]>** The custom parameters to set.
