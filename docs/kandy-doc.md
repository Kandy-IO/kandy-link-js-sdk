...
-   `options` **[Object][5]?** 
    -   `options.bandwidth` **[BandwidthControls][9]?** Options for configuring media's bandwidth.
...
Returns **[Array][6]&lt;[CallObject][10]>** Call objects.
...
-   `channel` **[Channel][15]** See the `Channel` module for information.
