...
This event is only required if you are using the `unified-plan` as the `sdpSemantics` setting in your configuration. This setting describes the formatting for the SDP to use for call control. This setting will be the default as of SDK v4.19.0.
...
```javascript
// Set listener for endeddd tracks.
