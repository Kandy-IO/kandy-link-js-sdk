...
<div class="call-control">
  ...
  <fieldset>
    ...
    <div class="bottomSpacing">
      ...
      Audio: <input type="checkbox" id="make-with-audio" disabled />
      Video: <input type="checkbox" id="make-with-video" disabled />
      Screen: <input type="checkbox" id="make-with-screen" disabled />
